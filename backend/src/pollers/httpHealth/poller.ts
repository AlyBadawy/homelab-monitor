...
import { listEnabledChecks, type HttpServiceCheck } from "./repo";
import { AppConfig } from "../../app/types";
import { replaceByPrefix, TargetSummary } from "../../state";
...
export class HttpsHealthPoller {
  ...
  private async probe(c: HttpServiceCheck): Promise<TargetSummary> {
  ...
  private errorTarget(c: HttpServiceCheck, e: unknown): TargetSummary {
